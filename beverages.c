...
void save_cart(const char *path, const char *product_name) //this is to save items to the cart,parameter 1-path of file cart.txt
{
...
/* ---------- append helper ---------- */
void append(Product **head, Product item) //and appends each one into the linked list
{
...
/* ---------- load / save ---------- */
Product *load_products(const char *path) //loads products from the text file into a struct object
{
...
void save_products(const char *path, Product *list) //writes all the details back into the text file again,only the quantity changes
{
